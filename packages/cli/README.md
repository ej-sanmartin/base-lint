...
> - GitHub-hosted runners inject these automatically, minting `GITHUB_TOKEN` for each workflow (see the [GitHub Action example](../../README.md#github-action) and [`packages/action/README.md`](../action/README.md) for why forked pull requests are skipped).
...
> - GitHub-hosted runners provide these automatically, with `GITHUB_TOKEN` issued per workflow (see the [GitHub Action example](../../README.md#github-action) and [`packages/action/README.md`](../action/README.md) for token scope details and fork safeguards).
